...
type ReporteHistorialVentasDto = ApiSchemas["ReporteHistorialVentasDto"];

/**
 * Route Handler del BFF para el historial de ventas del comerciante autenticado.
 *
...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    const reporte = await cliente.get<ReporteHistorialVentasDto>(
      "/reportes/historial-ventas",
    );
