...
/** Icono de persona para el campo de nombre. */
...
export function BotonVisibilidad({
  visible,
  onAlternar,
}: PropsBotonVisibilidad) {
  return (
    <button
      type="button"
      onClick={onAlternar}
      className={`${ESTILOS_ENLACE_FOCUS} rounded-lg p-2 text-elinain-muted transition-colors hover:text-white`}
